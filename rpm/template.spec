...
Name:           ros-rolling-gz-plugin-vendor
Version:        0.2.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS gz_plugin_vendor package
...
%description
Vendor package for: gz-plugin3 3.0.0 Gazebo Plugin : Cross-platform C++ library
...
* Mon Apr 08 2024 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.0.2-1
- Autogenerated by Bloom
